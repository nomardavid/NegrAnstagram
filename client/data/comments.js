const comments = {
  "BAhvZrRwcfu":[
    // {
    //   "text":"Cuando termines de ver nuestro nuevo albúm online, por fa revisa el ultimo y ultimo comentario",
    //   "user": "omar.revett"
    // }
  ],
  "BAcyDyQwcXX":[
  ...
  "-FpTyHQcauasda":[
    {
      "text":"Se que aveces no soy el novio perfecto, un ejemplo claro es el album de fotos que una vez te regale, y bueno, sigue en tu cuarto con ninguna, pero ahora tenemos nuestro propio album de fotos de instagram hecho por tu novio :3 👌🏻",
      "user": "omar.revett"
    }
    // {
    //   "text":"😱 jealous",
